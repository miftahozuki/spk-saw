    ...
    <div class="sidebar px-4 py-4 py-md-4 me-0">
        <div class="d-flex flex-column h-100">
            <a href="#" class="mb-0 brand-icon">
                ...
                <span class="logo-text">SPK SAW</span>
            </a>
            <!-- Menu: main ul -->
            <ul class="menu-list flex-grow-1 mt-3">
                <li><a class="m-link {{ request()->is('dashboard') ? 'active' : '' }}" href="{{ url('dashboard') }}"><i class="icofont-home fs-5"></i> <span>Dashboard</span></a></li>
                <li><a class="m-link {{ request()->is('data-pegawai') ? 'active' : '' }}" href="{{ url('data-pegawai') }}"><i class="icofont-funky-man fs-5"></i> <span>Data Pegawai</span></a></li>
            </ul>
                    ...
                    <div class="h-right d-flex align-items-center mr-5 mr-lg-0 order-1">
                                            ...
                                            <ul class="list-unstyled list mb-0">
                                                <li class="py-2 mb-1 border-bottom">
                                                    <a href="javascript:void(0);" class="d-flex">
                                                        <img class="avatar rounded-circle" src="{{ asset('frontend/assets/images/xs/avatar1.svg')}}" alt="">
                                                ...
                                                <li class="py-2 mb-1 border-bottom">
                                                    <a href="javascript:void(0);" class="d-flex">
                                                        <img class="avatar rounded-circle" src="{{ asset('frontend/assets/images/xs/avatar3.svg')}}" alt="">
                                                        <div class="flex-fill ms-2">
                                                ...
                                                <li class="py-2 mb-1 border-bottom">
                                                    <a href="javascript:void(0);" class="d-flex">
                                                        <img class="avatar rounded-circle" src="{{ asset('frontend/assets/images/xs/avatar5.svg')}}" alt="">
                                                        <div class="flex-fill ms-2">
                                                ...
                                                <li class="py-2 mb-1 border-bottom">
                                                    <a href="javascript:void(0);" class="d-flex">
                                                        <img class="avatar rounded-circle" src="{{ asset('frontend/assets/images/xs/avatar6.svg')}}" alt="">
                                                        <div class="flex-fill ms-2">
                                                ...
                                                <li class="py-2">
                                                    <a href="javascript:void(0);" class="d-flex">
                                                        <img class="avatar rounded-circle" src="{{ asset('frontend/assets/images/xs/avatar7.svg')}}" alt="">
                                                        <div class="flex-fill ms-2">
                        ...
                        <div class="dropdown user-profile ml-2 ml-sm-3 d-flex align-items-center zindex-popover">
                            ...
                            <a class="nav-link dropdown-toggle pulse p-0" href="#" role="button" data-bs-toggle="dropdown" data-bs-display="static">
                                <img class="avatar lg rounded-circle img-thumbnail" src="{{ asset('frontend/assets/images/profile_av.svg')}}" alt="profile">
                            </a>
                            <div class="dropdown-menu rounded-lg shadow border-0 dropdown-animation dropdown-menu-end p-0 m-0">
                                <div class="card border-0 w280">
                                    <div class="card-body pb-0">
                                        <div class="d-flex py-1">
                                            <img class="avatar rounded-circle" src="{{ asset('frontend/assets/images/profile_av.svg')}}" alt="profile">
        ...
        {{-- <div class="modal fade" id="depadd" tabindex="-1"  aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        <form>
                        <label for="exampleFormControlInput1111" class="form-label">Nama Pegawai </label>
